define([
  ...
  return function (options) {
      ...
      events: {
        ...
        "click #find-by-id": function () {
          ...
          if (this.model.get("id")) {
            Backbone.history.navigate("#/man/find-id/" + this.model.get("id"));
          }
          else {
            Backbone.history.navigate("#/man");
          }
          // if (Backbone.history.fragment.indexOf("man/search") === -1) {
          //   Backbone.history.navigate("#/man/search");
          // }
          // else {
          //   Backbone.history.navigate("#/man");
        ...
        "click #find-by-params": function () {
          ...
          if (currentUrl === "man" || currentUrl.indexOf("man/find-id/") !== -1) {
            ...
            Backbone.history.navigate("#/man/find-params?" + $.param(query));
          }
          else {
            Backbone.history.navigate("#/man");
    ...
    var SearchFormView = Backbone.View.extend({
      ...
      initialize: function () {
        if (Backbone.history.fragment.indexOf("man/find-params") !== -1) this.active = true;
        var searchFormView = this;
